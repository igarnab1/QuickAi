    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-xs font-light text-gray-500 mt-1'>
          Supports PDF formats only. Maximum file size: 5MB.
        </p>

        <button disabled={loading} className='w-full flex gap-3 justify-center items-center bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 rounded-lg mt-6 text-sm cursor-pointer hover:opacity-90'>
          {
